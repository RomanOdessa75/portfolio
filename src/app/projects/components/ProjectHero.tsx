      ...
      <div className="">
        <div className="">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-[10rem] font-normal text-brand-dark leading-tight">
              Entreaure
            </h1>
          ...
          <div className="flex items-center justify-between mt-6">
            <p className="text-xl md:text-4xl text-black font-light">
